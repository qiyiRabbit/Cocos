...
function MainScene:playAction(node,acNodeBase,act)
    ...
    -- local function lowAnim(fallAnin)
    --         --慢动作
    --         print("慢动作")
    --     self.animation2 = cc.Animation:create()
    --     for i = 3, actNum do
    --         local name = string.format(actName,i)
    --         self.animation2:addSpriteFrameWithFile(name)
    --     end
    --     self.animation2:setDelayPerUnit(0.5)
    --     self.animation2:setRestoreOriginalFrame(true)
    --     self.animation2:setLoops(1)
    --     local animates = cc.Animate:create(self.animation2)
    --     self:setObjectData("","playersAima",self.animation2)
    --     local function _callBack()
    --         fallAnin()
    --     end
    --     local callBack=cc.CallFunc:create(_callBack)
    --     local seq=cc.Sequence:create(animate,callBack)
    --     node:runAction(animates)
    -- end
    -- local function fallAnin()
    --     self.animation = cc.Animation:create()
    --     for i = 1, actNum-2 do
    --         local name = string.format(actName,i)
    --         self.animation:addSpriteFrameWithFile(name)
