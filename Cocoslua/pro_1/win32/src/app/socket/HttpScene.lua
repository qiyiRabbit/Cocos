require("json")
local HttpScene = class("HttpScene", cc.load("mvc").ViewBase)
function HttpScene:onCreate()
    --Response Code Label
    -- local labelStatusCode = cc.Label:createWithTTF("HTTP Status Code", "fonts/arial.ttf", 20)
    -- labelStatusCode:setAnchorPoint(cc.p(0.5, 0.5))
    -- labelStatusCode:setPosition(cc.p(display.cx,display.cy))
    -- self:addChild(labelStatusCode)
    ...
    local layer = self:XMLHttpRequestLayer()
    self:addChild(layer)
end

function HttpScene:XMLHttpRequestLayer()
    ...
    local function init()
        local label = cc.Label:createWithTTF("XML Http Request Test", "fonts/arial.ttf", 28)
        ...
        local labelGet  = cc.Label:createWithTTF("Test Get", "fonts/arial.ttf", 22)
        ...
        local labelPost = cc.Label:createWithTTF("Test Post", "fonts/arial.ttf", 22)
        ...
        local labelPostBinary = cc.Label:createWithTTF("Test Post Binary", "fonts/arial.ttf", 22)
        ...
        local labelPostJson = cc.Label:createWithTTF("Test Post Json", "fonts/arial.ttf", 22)
